...
\noindent \textbf{\textenglish{3.}} {\textarabic{احسب مشتق التابع \textbackslash{}( f(x) = x\^{}2\textbackslash{}) وأوجد نهايته عند اللانهاية \textbackslash{}(\textbackslash{}lim\_{x \textbackslash{}to \textbackslash{}infty}f(x)\textbackslash{})}}
...
\noindent \textbf{\textenglish{4.}} {\textenglish{Please calculate \textbackslash{}(\textbackslash{}int f(x)dx\textbackslash{})}}
...
\noindent \textbf{\textenglish{9.}} {\textenglish{Find the inverse of the following matrix: \textbackslash{}(\textbackslash{}begin{bmatrix} 1 \& 3 \& 4 \textbackslash{}\textbackslash{} 5 \& 2 \& 1 \textbackslash{}\textbackslash{} 6 \& 8 \& 1 \textbackslash{}end{bmatrix}\textbackslash{})}}
