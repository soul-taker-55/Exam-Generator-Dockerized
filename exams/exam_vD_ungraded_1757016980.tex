...
\noindent \textbf{\textenglish{6.}} {\textenglish{Solve for \textbackslash{}(x \textbackslash{}) in the equation \textbackslash{}(2x+6 = 0 \textbackslash{})}}
...
\noindent \textbf{\textenglish{7.}} {\textarabic{احسب مشتق التابع \textbackslash{}( f(x) = x\^{}2\textbackslash{}) وأوجد نهايته عند اللانهاية \textbackslash{}(\textbackslash{}lim\_{x \textbackslash{}to \textbackslash{}infty}f(x)\textbackslash{})}}
