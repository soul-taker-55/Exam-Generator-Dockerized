...
\noindent \qheader{5} {\textarabic{إذا كان لديك قائمة طويلة من أسماء الفواكه، لكنك تبحث عن "تفاحة". أي خوارزمية بحث ستستخدمها إذا كنت كسولاً وتتوقع أن "تفاحة" ستكون في مكان ما في منتصف القائمة؟}}
...
\noindent \qheader{8} {\textarabic{احسب مشتق التابع }}\( f(x) = x^2\){\textarabic{ وأوجد نهايته عند اللانهاية }}\(\lim_{x \to \infty}f(x)\)
...
\noindent \qheader{9} {\textarabic{ما هي الخوارزمية التي تستخدمها لتنظيم جوربك الملونة حسب اللون، ولكن فقط إذا كان لديك 3 جوارب؟}}
