...
\noindent \qheader{5} \begin{LTR}{\textenglish{Calculate the following Equations:
...
\noindent \qheader{10} {\textarabic{احسب مشتق التابع }}\( f(x) = x^2\){\textarabic{ وأوجد نهايته عند اللانهاية }}\(\lim_{x \to \infty}f(x)\)
