...
\noindent \qheader{1} {\textarabic{أنت في مطعم وطلبت طبقاً. بعد أن تأكل الطبق، يأتي النادل ويضع طبقًا آخر فوقه. ما هي بنية البيانات التي تشبه هذا الموقف؟}}
...
\noindent \qheader{3} {\textarabic{إذا كان لديك قائمة طويلة من أسماء الفواكه، لكنك تبحث عن "تفاحة". أي خوارزمية بحث ستستخدمها إذا كنت كسولاً وتتوقع أن "تفاحة" ستكون في مكان ما في منتصف القائمة؟}}
...
\noindent \qheader{5} \begin{LTR}{\textenglish{Find the inverse of the following matrix: }}\(\begin{bmatrix} 1 & 3 & 4 \\ 5 & 2 & 1 \\ 6 & 8 & 1 \end{bmatrix}\)\end{LTR}
...
\noindent \qheader{6} {\textarabic{ما هي الخوارزمية التي تستخدمها لتنظيم جوربك الملونة حسب اللون، ولكن فقط إذا كان لديك 3 جوارب؟}}
...
\noindent \qheader{7} {\textarabic{إذا كانت لدينا خوارزمية تستغرق نفس الوقت لحل مشكلة بغض النظر عن حجمها، فما هو اسمها؟}}

\renderchoices{\begin{LTR}{\textenglish{O(n)}}\end{LTR}}{\begin{LTR}{\textenglish{O(}}\(n^{2}\){\textenglish{)}}\end{LTR}}{\begin{LTR}{\textenglish{0}}\end{LTR}}{\underline{\begin{LTR}{\textenglish{0}}\end{LTR}}}{\begin{LTR}{\textenglish{0}}\end{LTR}}
{\begin{LTR}\hfill\textenglish{[1 Point]}\end{LTR}}\par\vspace{0.5em}
...
\noindent \qheader{9} {\textarabic{احسب مشتق التابع }}\( f(x) = x^2\){\textarabic{ وأوجد نهايته عند اللانهاية }}\(\lim_{x \to \infty}f(x)\)
