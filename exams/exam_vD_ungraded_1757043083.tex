...
\noindent \qheader{2} \begin{LTR}{\textenglish{Find the inverse of the following matrix: }}\(\begin{bmatrix} 1 & 3 & 4 \\ 5 & 2 & 1 \\ 6 & 8 & 1 \end{bmatrix}\)\end{LTR}
...
\noindent \qheader{5} {\textarabic{إذا كانت لدينا خوارزمية تستغرق نفس الوقت لحل مشكلة بغض النظر عن حجمها، فما هو اسمها؟}}
...
\noindent \qheader{7} \begin{LTR}{\textenglish{Solve for x..: }}\[2^x + 16 = 0 \]\end{LTR}
...
\noindent \qheader{8} \begin{LTR}{\textenglish{Calculate the following Equations:
