...
\noindent \qheader{4} {\textarabic{إذا كان لديك قائمة طويلة من أسماء الفواكه، لكنك تبحث عن "تفاحة". أي خوارزمية بحث ستستخدمها إذا كنت كسولاً وتتوقع أن "تفاحة" ستكون في مكان ما في منتصف القائمة؟}}
...
\noindent \qheader{8} \begin{LTR}{\textenglish{Solve for x..: }}\[2^x + 16 = 0 \]\end{LTR}
...
\noindent \qheader{9} \begin{LTR}{\textenglish{Calculate the following Equations:
