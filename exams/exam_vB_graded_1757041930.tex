...
\noindent \qheader{3} {\textarabic{احسب مشتق التابع }}\( f(x) = x^2\){\textarabic{ وأوجد نهايته عند اللانهاية }}\(\lim_{x \to \infty}f(x)\)
...
\noindent \qheader{6} {\textarabic{أنت في مطعم وطلبت طبقاً. بعد أن تأكل الطبق، يأتي النادل ويضع طبقًا آخر فوقه. ما هي بنية البيانات التي تشبه هذا الموقف؟}}
...
\noindent \qheader{9} \begin{LTR}{\textenglish{Find the inverse of the following matrix: }}\(\begin{bmatrix} 1 & 3 & 4 \\ 5 & 2 & 1 \\ 6 & 8 & 1 \end{bmatrix}\)\end{LTR}
